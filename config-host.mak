...
libs_softmmu=-lpixman-1   -lutil  -lpng12   -lSDL   -lX11    -lfdt
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.4.50
PKGVERSION=
SRC_PATH=/home/aquan/work/covert/qemu-tracer
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/aquan/work/covert/qemu-tracer/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
